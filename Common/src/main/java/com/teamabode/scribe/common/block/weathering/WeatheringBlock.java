package com.teamabode.scribe.common.block.weathering;
...
public interface WeatheringBlock extends ChangeOverTimeBlock<WeatherState> {
    ...
    default Optional<InteractionResult> interactionHandler(BlockState blockState, Level level, BlockPos blockPos, Player player, InteractionHand interactionHand, BlockHitResult blockHitResult) {
