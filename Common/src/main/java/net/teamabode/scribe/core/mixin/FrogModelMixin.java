...
import net.teamabode.scribe.api.animation.AnimationParser;
...
public class FrogModelMixin<T extends Frog> extends HierarchicalModel<T> {
    ...
    public void setupAnim(T frog, float f, float g, float h, float i, float j) {
        ...
        this.animate(frog.croakAnimationState, AnimationParser.getAnimation(new ResourceLocation(Scribe.MOD_ID, "scribe_animations/test.json")), h);
